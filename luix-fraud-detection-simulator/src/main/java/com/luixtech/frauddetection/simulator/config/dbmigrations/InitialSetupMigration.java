...
public class InitialSetupMigration implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        detectorRule1.setExpectedLimitValue(new BigDecimal("20000000"));
        ...
        detectorRule2.setExpectedLimitValue(new BigDecimal("300"));
        ...
        detectorRule3.setExpectedLimitValue(new BigDecimal("10000000"));
        ...
        detectorRule4.setExpectedLimitValue(new BigDecimal("100"));
